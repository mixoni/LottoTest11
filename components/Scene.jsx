...
class Scene extends React.Component {    
   ...
   RenderLastThreeResultsScene = () => {
        ...
        this.setState({ component : <Results lastThree={lastThree} remainingTime={15} sceneTime={15} onComplete = {this.RenderStatisticsScene} onTimerExpired={this.RenderStatisticsScene} /> })              
